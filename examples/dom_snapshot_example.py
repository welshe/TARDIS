...
if dom_snapshot_is_available():
    ...
    simulated_dom = {
        "schema": "0.2.0", "timestamp": 100.0, "method": "simulated",
...
if accessibility_snapshot_is_available():
    ...
    try:
        ...
        print(f"  Captured accessibility tree")
    except Exception as e:
    ...
    simulated_acc = {
        "schema": "0.2.0", "timestamp": 101.0, "method": "simulated",
        "desktop_name": "Desktop",
        "elements": {
            "role": "Pane", "name": "Desktop",
            "children": [
                {"role": "Window", "name": "Example App",
                 "children": [
                     {"role": "Button", "name": "Submit", "bounding_box": (100, 200, 80, 30)},
                 ]},
            ],
        },
    }
