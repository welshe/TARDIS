...
def create_grounding_failure_trace():
    ...
    trace.add_step(
        Step(
            ...
            input={"messages": "click button"},
            output={"content": "clicking"},
        )
    )
    trace.add_step(
        Step(
            ...
            input={"tool": "click", "coords": [100, 100]},
            output={},
        )
    )
    trace.add_step(
        Step(
            ...
            type=StepType.error,
            input={},
            output={"error": "ElementNotFound: element not found"},
        )
    )
    return trace
...
def create_environment_drift_trace():
    ...
    trace.add_step(
        Step(
            ...
            index=0,
            type=StepType.llm_call,
            input={"messages": "api call"},
            output={"content": "calling"},
        )
    )
    trace.add_step(
        Step(
...
def test_multiple_failure_patterns():
    ...
    trace.add_step(
        Step(
            ...
            type=StepType.error,
            input={},
            output={"error": "401 Unauthorized timeout"},
        )
    )
