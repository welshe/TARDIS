...
from tardis.orchestration import (
    ...
    SharedMemory, Orchestrator, orchestrate,
)
import time
...
class TestAgent:
    ...
    def test_agent_to_dict(self):
        agent = Agent("browser", capabilities={AgentCapability.browser, AgentCapability.vision}, model="gpt-4o")
        d = agent.to_dict()
...
class TestTask:
    def test_task_creation(self):
        task = Task("browse page", required_capabilities={"browser"}, priority=TaskPriority.high)
...
class TestOrchestrator:
    ...
    def test_run_sequential(self):
        ...
        results = orch.run_sequential(fn_map={"worker": lambda t: f"ok: {t.description}"})
